...
<main class="min-h-screen">
            ...
            <div class="container mx-auto py-2 px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                if ($latest_books->have_posts()) {
                    while ($latest_books->have_posts()) {
                        ...
                        <!-- Card -->
                        <div class="cols-span-1 flex flex-col bg-slate-100 border border-slate-200 rounded p-2 hover:bg-slate-200 hover:border-slate-100">
                            ...
                            <div class="mb-2 flex flex-wrap">
                                <?php if (has_post_thumbnail($post->ID)) { ?>
                                    <img class="rounded-t-md w-full h-48 object-cover overflow-hidden" src="<?php echo get_the_post_thumbnail_url($post->ID, 'thumbnail'); ?>" alt="" />
                                <?php } else { ?>
            ...
            <div class="container mx-auto py-2 px-4 grid grid-cols-1 gap-4">
                ...
                if ($latest_posts->have_posts()) {
                    while ($latest_posts->have_posts()) {
                        ...
                        <!-- Card -->
                        <div class="grid grid-cols-6 bg-slate-100 border border-slate-200 rounded p-2 hover:bg-slate-200 hover:border-slate-100">
    ...
    <!-- Section -->
    <section class="bg-slate-300">
        <div class="py-8 px-4 mx-auto max-w-screen-4xl text-center lg:py-16">
