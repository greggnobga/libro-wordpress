...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="cursor-pointer">
    <path d="M298.39 248a4 4 0 002.86-6.8l-78.4-79.72a4 4 0 00-6.85 2.81V236a12 12 0 0012 12z" fill={`${color ? color : '#1E293B'}`}></path>
    <path
